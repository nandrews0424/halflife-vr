...
OutFile ".\output\halflife-vr-mp-${VERSION}.exe"
...
!define MUI_WELCOMEPAGE_TITLE 'Welcome to the installation for Half-Life 2 VR Multiplayer v${VERSION}'
!define MUI_WELCOMEPAGE_TEXT 'Thanks for installing Half-Life VR Multiplayer, this should only take a few seconds.  \
...
!define MUI_FINISHPAGE_TEXT "Half-life VR Multiplayer is now installed.  You'll need to restart steam to see the mod in your games list on Steam."
...
Section "" 
	...
	SetOutPath $INSTDIR\halflife-vr-mp
	File /r ..\mod_hl2mp\*
...
Function .onInit
	...
	ReadRegDWORD $SDK_INSTALLED HKCU "Software\Valve\Steam\Apps\243750" "Installed"
	...
	StrCmp $SDK_INSTALLED "1" SDK_INSTALLED
		...
		MessageBox MB_YESNO|MB_ICONQUESTION \
		    "The Source SDK 2013 Multiplayer is required to play this mod but wasn't \ 
